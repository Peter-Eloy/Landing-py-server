export default function Footer() {
  ...
  const X_HANDLE = "petereloy";
  const INSTAGRAM_HANDLE = "peter.eloy";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-gray-400 text-sm">
            <p>© {currentYear} Mock API Server.</p>
            <p className="mt-1">
              <a
          ...
          <div className="flex flex-col items-center gap-3 text-sm">
            ...
            <a
              href={`https://github.com/${GITHUB_USERNAME}/${REPO_NAME}#readme`}
              target="_blank"
              rel="noopener noreferrer"
          ...
          {/* Right - Tech Stack & Developer */}
          <div className="text-right text-sm text-gray-400">
            <p className="mb-2">Built with Python, Flask, PyInstaller</p>
        ...
        <div className="md:hidden flex flex-col gap-6 text-center">
          ...
          <div className="text-sm text-gray-400">
            <p className="mb-3">Built with Python, Flask, PyInstaller</p>
